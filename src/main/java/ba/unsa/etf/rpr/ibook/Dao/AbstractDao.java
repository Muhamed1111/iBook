...
public abstract class AbstractDao<T extends Idable> implements Dao<T> {
     ...
     * @throws BookException in case of error with db
     */
     ...
     * @throws BookException in case of error with db
     */
    public List<T> executeQuery(String query, Object[] params) throws BookException{
        try {
     ...
     * @return Object
     * @throws BookException in case when object is not found
     */
    public T executeQueryUnique(String query, Object[] params) throws BookException{
